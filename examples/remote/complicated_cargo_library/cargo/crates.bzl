...
def complicated_cargo_library_fetch_remote_crates():
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:arrayvec-0.4.10.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:cfg-if-0.1.7.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:crossbeam-deque-0.2.0.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:crossbeam-epoch-0.3.1.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:crossbeam-utils-0.2.2.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:derivative-1.0.2.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:lazy_static-1.3.0.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:libc-0.2.53.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:memchr-2.2.0.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:memoffset-0.2.1.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:nodrop-0.1.13.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:num_cpus-1.10.0.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:proc-macro2-0.4.28.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:quote-0.6.12.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:rayon-core-1.4.1.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:redox_syscall-0.1.54.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:scopeguard-0.3.3.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:syn-0.15.33.BUILD")
    )
    ...
    _new_http_archive(
        name = "complicated_cargo_library__ucd_util__0_1_3",
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:ucd-util-0.1.3.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:utf8-ranges-1.0.2.BUILD")
    )
    ...
    _new_http_archive(
        ...
        build_file = Label("//remote/complicated_cargo_library/cargo/remote:winapi-0.3.7.BUILD")
    )
