...
def remote_non_cratesio_fetch_remote_crates():
    ...
    maybe(
        ...
        build_file = Label("//remote/non_cratesio/cargo/remote:aho-corasick-0.6.10.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//remote/non_cratesio/cargo/remote:env_logger-0.5.5.BUILD.bazel"),
    ...
    maybe(
        ...
        build_file = Label("//remote/non_cratesio/cargo/remote:fuchsia-zircon-0.3.3.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//remote/non_cratesio/cargo/remote:fuchsia-zircon-sys-0.3.3.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//remote/non_cratesio/cargo/remote:log-0.4.0.BUILD.bazel"),
        init_submodules = True,
    )
    ...
    maybe(
        ...
        build_file = Label("//remote/non_cratesio/cargo/remote:regex-0.2.11.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//remote/non_cratesio/cargo/remote:regex-syntax-0.5.6.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//remote/non_cratesio/cargo/remote:termcolor-0.3.6.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//remote/non_cratesio/cargo/remote:thread_local-0.3.6.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//remote/non_cratesio/cargo/remote:winapi-i686-pc-windows-gnu-0.4.0.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//remote/non_cratesio/cargo/remote:winapi-x86_64-pc-windows-gnu-0.4.0.BUILD.bazel"),
    )
    ...
    maybe(
        ...
        build_file = Label("//remote/non_cratesio/cargo/remote:wincolor-0.1.6.BUILD.bazel"),
    )
